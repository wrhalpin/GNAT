"""
ctm_sak.reports.renderers
==========================

Four report renderers — Markdown, HTML, PDF, DOCX — all consuming the
same :class:`~ctm_sak.reports.base.ReportDocument` intermediate structure.
...
if TYPE_CHECKING:
    from ctm_sak.reports.base import ReportDocument, ReportSection
...
class MarkdownRenderer:
    ...
    def _build(self, doc: "ReportDocument") -> str:
        ...
        lines.append("---")
        lines.append(f"*Generated by CTM-SAK threat intelligence platform*")
...
<div class="container">
  ...
  <div class="footer">Generated by CTM-SAK Threat Intelligence Platform</div>
</div>
</body>
</html>"""
...
class PDFRenderer:
    ...
    def render(self, doc: "ReportDocument", path: str) -> str:
        ...
        story.append(Paragraph(
            "Generated by CTM-SAK Threat Intelligence Platform",
...
const children = [
  ...
  {sections_js}
  new Paragraph({{
    children: [new TextRun({{ text: "Generated by CTM-SAK Threat Intelligence Platform",

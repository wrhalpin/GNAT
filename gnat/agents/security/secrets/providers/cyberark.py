...
class CyberArkProvider:
    ...
    def capabilities(self) -> ProviderCapabilities:
        return ProviderCapabilities(supports_read=True, supports_write=False, supports_rotation=True, supports_checkout=True)
    def resolve(self, ref: SecretRef) -> SecretValue:
        raise UnsupportedProviderAction("cyberark provider placeholder does not implement direct resolve")
